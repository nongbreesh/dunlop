...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            Video  <a href="javascript:;" onclick="add_product()" class="add-new-h2">Add Video</a>
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-shopping-cart"></i> Add Video</h4>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#form_add_product").on('submit', function(e) {
            ...
            if (is_update == 'false') {
                $.ajax({
                    url: "<?php echo base_url(); ?>" + "index.php/service/add_video",
                    type: "POST",
                    data: $(this).serialize(),
                    dataType: "json",
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>" + "index.php/service/edit_video/" + input_id,
                    type: "POST",
                    data: $(this).serialize(),
                    dataType: "json",
                    success: function(data) {
    ...
    function edit_product(id) {
        ...
        if (id != "") {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "index.php/service/getvideo_detail",
                data: {"id": id},
                dataType: 'json',
                success: function(data) {
                  // console.log(data);
                    $('#input_headine').val(data.result.VIDEO_Headline);
                    $('#input_url').val(data.result.VIDEO_LINK);
    ...
    function removedata(id) {
        if (confirm('ต้องการลบข้อมูลหรือไม่?')) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "index.php/service/delete_video",
                data: {'id': id},
                dataType: "json",
                success: function(data) {
    ...
    function update_list() {
        ...
        setTimeout(
                function()
                {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>" + "index.php/service/load_video",
                        dataType: "html",
                        success: function(data) {
