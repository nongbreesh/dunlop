...
class Insert_model extends CI_Model {
    ...
    function insert_Product($input) {
        ...
        if ($this->db->insert('dunlop_product', $input)):
            return true;
        else:
            return false;
        endif;
    ...
    function insert_Tire($input) {

        if ($this->db->insert('dunlop_tire', $input)):
            return true;
        else:
            return false;
        endif;
    ...
    function insert_Group($input) {
        ...
        if ($this->db->insert('dunlop_group', $input)):
            return true;
        else:
            return false;
        endif;
    ...
    function insert_Category($input) {
        ...
        if ($this->db->insert('dunlop_type', $input)):
            return true;
        else:
            return false;
        endif;
    ...
    function insert_knowledge_Category($input) {

        if ($this->db->insert('dunlop_knowledge_cate', $input)):
            return true;
        else:
            return false;
        endif;
    ...
    function insert_about_Category($input) {

        if ($this->db->insert('dunlop_about_cate', $input)):
            return true;
        else:
            return false;
        endif;
