...
<!-- Morris.js charts -->
<script src="<?php echo base_url() ?>public/js/plugins/raphael/2.1.0/raphael-min.js"></script>
...
<!-- bootstrap-growl -->
<script src="<?php echo base_url() ?>/public/js/plugins/bootstrap-growl/bootstrap-growl.js" type="text/javascript"></script>
