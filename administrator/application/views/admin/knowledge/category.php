...
<script>
    $(document).ready(function() {
        ...
        $("#form_add_cate").on('submit', function(e) {
            ...
            $btn.button('loading');
            $.ajax({
                url: "<?php echo base_url(); ?>" + "index.php/service/add_knowledge_category",
                type: "POST",
                data: $(this).serialize(),
                dataType: "json",
        ...
        $("#form_edit_cate").on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>" + "index.php/service/update_knowledge_cate/" + id,
                type: "POST",
                data: $(this).serialize(),
                dataType: "json",
                success: function(data) {
    ...
    function load_cate_list() {
        ...
        setTimeout(
                function()
                {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>" + "service/load_knowledge_cate_list",
                        dataType: "html",
                        success: function(data) {
                            $('#cate_list').html(data);
                        },
    ...
    function editdata(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "service/load_knowledge_detail",
            data: {'id': id},
            dataType: "json",
            success: function(data) {

                $("#input_hddcate").val(data.result.Cate_ID);
                $("#inputedit_catename").val(data.result.Cate_Name);
            },
            error: function(XMLHttpRequest) {
                console.log(XMLHttpRequest.status);
            }
    ...
    function removedata(id) {
        if (confirm('ต้องการลบข้อมูลหรือไม่?')) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "index.php/service/delete_knowledge_cate",
                data: {'id': id},
                dataType: "json",
                success: function(data) {
    ...
    function load_category() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/service/get_knowledge_category",
            dataType: "json",
            success: function(data) {
