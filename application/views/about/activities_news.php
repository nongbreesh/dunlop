                                ...
                                <div class="wrapper">
                                    <div class="sidebar-l" ><div class="about_title"></div>
                                        ...
                                        <ul class="sidemenu">
                                            ...
                                            <li><a href="<?php echo  base_url() ?>about/activities"><img style="" src="<?php echo  base_url() ?>public/images/activities_hover.png" /></a></li>
                                    ...
                                    <div class="contact-r " >
                                        <div class="title_trans-r"> <h1><img   style="margin-top: 22px;" src="<?php echo  base_url() ?>public/images/activity_header.png" /></h1></div>
                                        <div class="content-activities_headline"><?php echo  $content->Content_Headline ?></div>
                                        <div class="content-activities-detail ">
                                                ...
                                                <div class="albumpic">
                                                    <ul class="bxslider">
                                                        <?php foreach ($albumpic as $each): ?>
                                                            <li>
                                                                <div  style="cursor: pointer;"><img src="<?php echo  base_url() ?>administrator/public/uploads/<?php echo  str_replace('thumb_', '', $each->PIC_Image) ?>" width="100%" /></div>
                                            ...
                                            <?php endif; ?>
                                            <?php echo  $content->Content_detail ?>
