...
<html>
    <head>
        ...
        <link rel="stylesheet/less" type="text/css" href="<?php echo  base_url('public') . '/less/datepicker.less' ?>" />
            ...
            <header>
                <section class=" col-lg-12 col-md-12 col-sm-12">
                    ...
                    <ul class="mini_nevigator">
                        ...
                        <li><a href="<?php echo  base_url(); ?>pages/contactus">ติดต่อเรา</a></li>
                    </ul>
                    <ul class="social">
                        <li><a  target="_blank" href="https://www.facebook.com/pages/Rochu-beauty-%E0%B8%84%E0%B8%A3%E0%B8%B5%E0%B8%A1%E0%B8%9E%E0%B8%B4%E0%B8%A9%E0%B8%87%E0%B8%B9/1398840677064214"><img src="<?php echo  base_url(); ?>public/images/logo-facebook.png"  width="30"/></a></li>
                        <li><a target="_blank" href="https://instagram.com/rochubeauty"><img src="<?php echo  base_url(); ?>public/images/logo-instagram.jpg"   width="30"/></a></li>
                        <li><a href="javascript:;" data-toggle="modal" data-target="#LineModal"><img src="<?php echo  base_url(); ?>public/images/logo-line.png"  width="30" /></a></li>
                    </ul>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="<?php echo  base_url(); ?>public/images/logo-line.png"  width="30" /> <b>ID : peijangkyo</b>
                                    <br/>   <br/>
                ...
                <div class="col-lg-12 main_menu">
                    ...
                    <section class="col-lg-12">
                        ...
                        <ul >
                            ...
                            <li><a href="<?php echo  base_url(); ?>item/all">สินค้าทั้งหมด</a></li>
                            <li><a href="<?php echo  base_url() ?>pages/payment">แจ้งชำระเงิน</a></li>
                            <li><a href="<?php echo  base_url(); ?>pages/contactus">ติดต่อเรา</a></li>
                            <li><a href="<?php echo  base_url(); ?>pages/view/10">วิธีการซื้อสินค้า</a></li>
                            <li><a href="<?php echo  base_url(); ?>pages/trackingdata">สถานะการส่งสินค้า</a></li>
                        </ul>
                    </section>
                </div>
                ...
                <div class="cart_mini">
                    ...
                    <?php else: ?>
                        ...
                        ?>
                        <span class="badge pull-right cart_mini_count" style="background: #FF4141;"><?php echo  count($_SESSION['SHOPPING_CART']) ?></span>
                    <?php endif; ?>
