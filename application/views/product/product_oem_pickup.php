                                ...
                                <div class="wrapper">
                                    <div class="sidebar-l" ><div class="product_title"></div>
                                        ...
                                        <ul class="sidemenu">
                                            ...
                                            <li><a href="<?= base_url() ?>product/product_oem_4x4"><img style="" src="<?= base_url() ?>public/images/product/OEM_Sub_2.png"  onmouseover="this.src = '<?= base_url() ?>public/images/product/OEM_Sub_2_OV.png'" onmouseout="this.src = '<?= base_url() ?>public/images/product/OEM_Sub_2.png'"/></a></li>
                                            <li><a href="<?= base_url() ?>product/product_oem_pickup"><img style="" src="<?= base_url() ?>public/images/product/OEM_Sub_3_OV.png"/></a></li>
                                    ...
                                    <div class="contact-r " >
                                        ...
                                        <div class="passenger_car">
                                            <img style="" src="http://www.dunloptire.co.th/img/pickup_oem.jpg" width="640" />
                                        </div>
