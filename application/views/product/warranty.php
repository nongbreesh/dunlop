                            ...
                            <td> 
                                ...
                                <div class="wrapper">
                                    <div class="sidebar-l" ><div class="product_title"></div>
                                        ...
                                        <ul class="sidemenu">
                                            <li><a href="<?php echo  base_url() ?>product/index"><img style="" src="<?php echo  base_url() ?>public/images/product/Product_menu_1.png" onmouseover="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_1_OV.png'" onmouseout="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_1.png'" /></a></li>
                                            <li><a href="<?php echo  base_url() ?>product/product_4x4"><img style="" src="<?php echo  base_url() ?>public/images/product/Product_menu_3.png"  onmouseover="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_3_OV.png'" onmouseout="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_3.png'"/></a></li> 
                                            <li><a href="<?php echo  base_url() ?>product/product_pickup"><img style="" src="<?php echo  base_url() ?>public/images/product/Product_menu_2.png" onmouseover="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_2_OV.png'" onmouseout="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_2.png'"/></a></li>
                                            <li><a href="<?php echo  base_url() ?>product/product_oem"><img style="" src="<?php echo  base_url() ?>public/images/product/Product_menu_4.png" onmouseover="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_4_OV.png'" onmouseout="this.src = '<?php echo  base_url() ?>public/images/product/Product_menu_4.png'"/></a></li>
                                            <li><a href="<?php echo  base_url() ?>product/warranty"><img style="" src="<?php echo  base_url() ?>public/images/product/Product_menu_5_OV.png" /></a></li>
                                        </ul>
                                    </div>
                                    <div class="contact-r " >
