                                ...
                                <div class="wrapper">
                                    <div class="sidebar-l" ><div class="product_title"></div>
                                        ...
                                        <ul class="sidemenu">
                                            ...
                                            <li><a href="<?= base_url() ?>product/dz102"><img style="" src="<?= base_url() ?>public/images/product/Product_sub_5_OV.png" /></a></li>
                                                            ...
                                                            <td colspan="2">
                                                                <table border="0" cellpadding="0" cellspacing="0" >
                                                                    <tbody>
                                                                        <tr>
                                                                            <td colspan="5"><br />
                                                                                <img alt="" src="http://www.dunloptire.co.th/img/direzza101.jpg" style="height:30px; width:337px" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>&nbsp;</td>
                                                                            <td><a href="http://www.dunloptire.co.th/product/passenger/dz102.html"><img alt="product info" src="http://www.dunloptire.co.th/img/productinfo.jpg" style="height:22px; width:119px" /></a></td>
                                                                            <td><a href="http://www.dunloptire.co.th/product/passenger/dz102-tech.html"><img alt="technology" src="http://www.dunloptire.co.th/img/techno-hover.jpg" style="height:22px; width:125px" /></a></td>
                                                                            <td>&nbsp;</td>
                                                                            <td>&nbsp;</td>
                                                                        </tr>
                                                                    </tbody>
                                                            ...
                                                            <td>
                                                                <table align="right" border="0" cellpadding="0" cellspacing="0" >
                                                                    <tbody>
                                                                        <tr>
                                                                            <td><br />
                                                                                <img src="http://www.dunloptire.co.th/img/dz101-tech01.jpg" style="height:301px; width:709px" /><br />
                                                                                1. ประสิทธิภาพบนถนนแห้งและเปียกดีเยี่ยม ( การยึดเกาะถนน/รองรับการลื่นไถล/เบรคได้ตามความต้องการ)<br />
                                                                                ส่วนผสมชนิดพิเศษมีการออกแบบสำหรับ DIREZZA ในการรวมเข้าด้วยกันของ Super Abrasion Carbon ที่ก่อให้เกิดความร้อนและ Silica ทำให้ยางนุ่มนวลขณะยึดเกาะถนนเปียก !!</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <p><img src="http://www.dunloptire.co.th/img/dz101-tech02.jpg" style="height:256px; width:735px" /><br />
                                                                                    2. เกิดเสียงรบกวนต่ำและการขับขี่ดีเยี่ยม<br />
                                                                                    ลวดลายที่หน้ายางมีเสียงรบกวนต่ำเป็นการพัฒนาจากการจำลองเรื่องเสียงรบกวนทำการจัดเรียงความไม่เป็นระเบียบที่เกิดขึ้น การกระจายตำแหน่งร่องดอกยางและมุมที่เหมาะสมซึ่งได้มาจากการคำนวณ และ Hybrid Band ก็เช่นกันที่ประสบความสำเร็จในการควบคุมการสั่นสะเทือนของรถยนต์และเสียงรบกวนต่ำซึ่งเป็นความถี่ที่ไม่พึงประสงค์</p>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><img src="http://www.dunloptire.co.th/img/dz101-tech03.jpg" style="height:205px; width:665px" /><br />
                                                                                3. การต้านทานการสึกหรอเพิ่มมากขึ้น DIREZZA มีการพัฒนามาจากต้นแบบของเราเองในเรื่องค่าการสึกหรอสูงสุด โดยควบคุมไม่ให้เกิดการสึกหรอที่มากเกินไป !! มั่นใจได้ว่าได้มีการสัมผัสพื้นที่เล็กๆ&nbsp;<br />
                                                                                และเกิดการสึกหรอที่สม่ำเสมอไม่รุนแรง สำหรับการขับขี่แบบสปอร์ต</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><img src="http://www.dunloptire.co.th/img/dz101-tech04.jpg" style="height:149px; width:735px" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>4. ประสิทธิภาพในการต้านทานการเหินน้ำดีเยี่ยม<br />
                                                                                เทคโนโลยีในการจำลอง มีการสรุปรวมกันถึงร่องดอกยางในแนวเส้นตรงที่กว้างและร่องดอกยางด้านข้างที่ยาว ซึ่งจะทำให้เกิดการรีดน้ำที่ดีเยี่ยม โดยสามารถมองเห็นได้อย่างชัดเจน!<br />
                                                                                <img src="http://www.dunloptire.co.th/img/dz101-tech05.jpg" style="height:256px; width:391px" /></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
